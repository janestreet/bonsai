...
module Impl = struct
  ...
  let map2 ?here:(_ = Stdlib.Lexing.dummy_pos) x1 x2 ~f = f x1 x2
  let map3 ?here:(_ = Stdlib.Lexing.dummy_pos) x1 x2 x3 ~f = f x1 x2 x3
  let map4 ?here:(_ = Stdlib.Lexing.dummy_pos) x1 x2 x3 x4 ~f = f x1 x2 x3 x4
  let map5 ?here:(_ = Stdlib.Lexing.dummy_pos) x1 x2 x3 x4 x5 ~f = f x1 x2 x3 x4 x5
  let map6 ?here:(_ = Stdlib.Lexing.dummy_pos) x1 x2 x3 x4 x5 x6 ~f = f x1 x2 x3 x4 x5 x6

  let map7 ?here:(_ = Stdlib.Lexing.dummy_pos) x1 x2 x3 x4 x5 x6 x7 ~f =
